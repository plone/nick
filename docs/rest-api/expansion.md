...
```http
{% include_relative endpoints/examples/expansion/get.req %}
```

Or use the client directly:

```ts
{% include_relative endpoints/examples/expansion/get.ts %}
```

Example response:

```http
{% include_relative endpoints/examples/expansion/get.res %}
```

In order to expand and embed the translations component, use the `GET` parameter expand with the value translations.

```http
{% include_relative endpoints/examples/expansion/get_expanded.req %}
```

Or use the client directly:

```ts
{% include_relative endpoints/examples/expansion/get_expanded.ts %}
```

Example response:

```http
{% include_relative endpoints/examples/expansion/get_expanded.res %}
```
