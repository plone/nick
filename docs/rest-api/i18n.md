...
```http
{% include_relative endpoints/examples/i18n/list.req %}
```

Or use the client directly:

```ts
{% include_relative endpoints/examples/i18n/list.ts %}
```

And the response:

```http
{% include_relative endpoints/examples/i18n/list.res %}
```
